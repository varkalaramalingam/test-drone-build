...
import AddEditPeopleAwards from "./AddEditPeopleAwards";
...
function Awards({titleId}) {
  ...
  const getAwardsData = () => {
    io({ method: "get", url: `/api/mastermeta/${titleId}/{peopleId}/awards` })
      .then(({data}) => {
  ...
  const deleteRecord = (record) => {
    io({
      method: "delete",
      url: `/api/mastermeta/${titleId}/{peopleId}/awards/${record.id}`,
    })
      .then((data) => {
  ...
  return (
    <> 
      <AddEditPeopleAwards isAdd={true} getAwardsData={getAwardsData} titleId={titleId}/>
      <Table
      ...
      >
        ...
        <Column
          ...
          render={(text, record) => (
            <>
            <AddEditPeopleAwards isAdd={false} initialData={record} getAwardsData={getAwardsData} titleId={titleId}/>
